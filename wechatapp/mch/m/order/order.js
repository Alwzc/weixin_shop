...
Page({
    ...
    loadOrderList: function(t) {
        var e = this, a = e.data.status, o = (e.data.current_page || 0) + 1, s = e.data.keyword || "";
        app.request({
    ...
    refundPass: function(t) {
        var e = this, a = t.currentTarget.dataset.index, o = e.data.order_list[a].id, s = e.data.order_list[a].type;
        wx.showModal({
            title: "提示",
    ...
    refundDeny: function(t) {
        var e = this, a = t.currentTarget.dataset.index, o = e.data.order_list[a].id;
