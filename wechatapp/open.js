...
if ("undefined" != typeof wx) hj = wx; else {
    ...
    hj.removeStorageSync = function(e) {
        ...
        if ("get" == e.method.toLowerCase() && e.data) {
            var t = objectToUrlParams(e.data, !0);
            e.url += "&" + t, e.data = null;
        }
        my.httpRequest(e);
    ...
    hj.createAnimation = function(e) {
        ...
        my.tradePay({
            orderStr: n._res.data,
            success: function(e) {
                console.log("success---\x3e", e);
            },
            fail: function(e) {
                console.log("fail---\x3e", e);
            },
            complete: function(e) {
                console.log("complete---\x3e", e);
                var t = {};
    ...
    hj.chooseImage = function(o) {
        chooseImage({
            success: function(e) {
                if ("function" == typeof o.success) {
                    var t = {
                        tempFilePaths: [],
                        tempFiles: []
                    };
            ...
            error: function(e) {
                "function" == typeof o.error && o.error(e);
            },
            complete: function(e) {
                "function" == typeof o.complete && o.complete(e);
            }
        });
    };
