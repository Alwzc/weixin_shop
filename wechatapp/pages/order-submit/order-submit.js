...
Page({
    ...
    onLoad: function(t) {
        ...
        wx.removeStorageSync("input_data"), t.pond_id && a.setData({
            pond_id: t.pond_id
    ...
    orderSubmit: function(t) {
        ...
        if (1 == s.is_form && a.data.goods_list && a.data.goods_list.length) {
            ...
            } else if (!d[o].default || null == d[o].default) return wx.showModal({
                title: "提示",
                content: "请填写" + s.name + "，加‘*’为必填项",
                showCancel: !1
            }), !1;
    ...
    onShow: function(t) {
        if (!getApp().onShowData || !getApp().onShowData.scene || 1034 != getApp().onShowData.scene && "pay" != getApp().onShowData.scene) if (loadingImg) loadingImg = !1; else {
            ...
            if (e) {
                ...
                var i = {};
                i.address = e, i.name = e.name, i.mobile = e.mobile, wx.removeStorageSync("picker_address"), 
    ...
    pickCoupon: function(t) {
        ...
        wx.removeStorageSync("input_data"), e.picker_coupon = "-1" != a && -1 != a && this.data.coupon_list[a], 
    ...
    pickShop: function(t) {
        var a = t.currentTarget.dataset.index, e = wx.getStorageSync("input_data");
        wx.removeStorageSync("input_data"), e.shop = "-1" != a && -1 != a && this.data.shop_list[a], 
