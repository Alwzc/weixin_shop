...
class AlipayController extends Controller
{
    ...
    {
        $alipayDir = \Yii::$app->basePath . '/web/antapp'; // 配置支付宝前端包目录
        $apiJsPath = $alipayDir . '/api.js'; // api.js 路径
        $apiJsTplPath = $alipayDir . '/api.tpl.js'; // api.tpl.js 路径
        $entryUri = \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/index.php?store_id=' . $this->store->id . '&r=api/'; // API 入口
