...
class UserController extends Controller
{
    ...
    public function actionRechange()
    {
        ...
        $integralLog->username = $user->nickname ? $user->nickname : '未知';
    ...
    public function actionBuy($keyword = null)
    {
        ...
        $list = $query->select(['ro.*', 'u.nickname','u.platform', 'after_name' => $afterQuery, 'current_name' => $currentQuery])
            ->limit($p->limit)->offset($p->offset)->orderBy('ro.addtime DESC')->asArray()->all();
