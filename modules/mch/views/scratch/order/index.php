                        ...
                        <div class="mr-4">
                            <div class="form-group">
                                ...
                                <a class="btn btn-secondary del"
                                   href="javascript:"
                                   data-url="<?= $urlManager->createUrl(['mch/scratch/order/delete-all']) ?>"
                ...
                <table class="table table-bordered bg-white">
                    ...
                    <tr>
                        ...
                        <td class="order-tab-2">
                            <span><span class="titleColor">总金额：</span><span style="color:blue;"><?= $order_item['total_price'] ?></span></span>
                            <?php if ($order_item['express_price_1']): ?>
                                <span><span class="titleColor">（含运费：</span><span style="color:green;"><?= $order_item['express_price_1'] ?></span>元）</span>
                                <div class="text-danger">包邮，运费减免</div>
                            <?php else: ?>
                                <span><span class="titleColor">（含运费：</span><span style="color:green;"><?= $order_item['express_price'] ?></span>元）</span>
                            <?php endif; ?>
                            <?php if ($order_item['user_coupon_id']): ?>
                                <div><span class="titleColor">优惠券：</span><span style="color:red;"><?= $order_item['coupon_sub_price'] ?></span>元</div>
                            <?php endif; ?>
                            <?php if ($order_item['before_update_price']): ?>
                                <?php if ($order_item['pay_price'] > $order_item['before_update_price']): ?>
                                    <div><span class="titleColor">后台加价：</span><span style="color:red;"><?= $order_item['pay_price'] - $order_item['before_update_price'] ?></span>元
                                    </div>
                                <?php else: ?>
                                    <div><span class="titleColor">后台优惠：</span><span style="color:red;"><?= $order_item['before_update_price'] - $order_item['pay_price'] ?></span>元
                                    </div>
                                <?php endif; ?>
                            <?php endif; ?>
                            <?php if ($order_item['integral'] && $order_item['integral']['forehead_integral']): ?>
                                <div><span class="titleColor">使用<?= $order_item['integral']['forehead_integral'] ?>积分抵扣：</span><span style="color:red;"><?= $order_item['integral']['forehead'] ?></span>元</div>
                            <?php endif; ?>
                            <?php if ($order_item['discount'] && $order_item['discount'] != 10): ?>
                                <div><span class="titleColor">会员折扣：<span style="color:blue;"></span><?= $order_item['discount'] ?></span>折</div>
                            <?php endif; ?>
                            ...
                            <div>
                               ...
                               <?php if ($order_item['is_send'] == 1): ?>
                                    <?php if ($order_item['is_offline'] == 0 || $order_item['express']): ?>
                                        <span><span class="badge badge-default mr-1"><?= $order_item['express'] ?></span><span class="titleColor">快递单号：</span><a href="https://www.baidu.com/s?wd=<?= $order_item['express_no'] ?>"
