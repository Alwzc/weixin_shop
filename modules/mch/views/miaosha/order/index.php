                        ...
                        <div class="mr-4">
                            <div class="form-group">
                                ...
                                <a class="btn btn-secondary del"
                                   href="javascript:"
                                   data-url="<?= $urlManager->createUrl(['mch/miaosha/order/delete-all']) ?>"
                ...
                <table class="table table-bordered bg-white">
                    <tr>
                        <td colspan="5">
                            ...
                            <span class="mr-5">
                                <span class="titleColor">用户名：</span>
                                <?= $order_item['nickname'] ?>
                    ...
                    <tr>
                        ...
                        <td class="order-tab-2">
                            ...
                            <?php if ($order_item['express_price_1']): ?>
                                    <span>（含运费：<span style="color:green;"><?= $order_item['express_price_1'] ?></span>元）</span>
                                <div class="text-danger">包邮，运费减免</div>
                            <?php else: ?>
                                    <span>（含运费：<span style="color:green;"><?= $order_item['express_price'] ?></span>元）</span>
                            <?php endif; ?>
                            ...
                            <?php if ($order_item['before_update_price']): ?>
                                <?php if ($order_item['pay_price'] > $order_item['before_update_price']): ?>
                                        <div>后台加价：<span style="color:red;"><?= $order_item['pay_price'] - $order_item['before_update_price'] ?></span>元
                                    </div>
                                <?php else: ?>
                                        <div>后台优惠：<span style="color:red;"><?= $order_item['before_update_price'] - $order_item['pay_price'] ?></span>元
                                    </div>
                                <?php endif; ?>
                            <?php endif; ?>
                            <?php if ($order_item['integral'] && $order_item['integral']['forehead_integral']): ?>
                                    <div>使用<?= $order_item['integral']['forehead_integral'] ?>积分抵扣：<span style="color:red;"><?= $order_item['integral']['forehead'] ?></span>元</div>
                            <?php endif; ?>
                        ...
                        <td colspan="5">
                            ...
                            <?php if ($order_item['is_send'] == 1): ?>
                                <?php if ($order_item['is_offline'] == 0 || $order_item['express']): ?>
                                    ...
                                    <span>快递单号：<a href="https://www.baidu.com/s?wd=<?= $order_item['express_no'] ?>"
