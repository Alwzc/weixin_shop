                        ...
                        <div class="mr-4">
                            <div class="form-group">
                                ...
                                <a class="btn btn-secondary del"
                                   href="javascript:"
                                   data-url="<?= $urlManager->createUrl(['mch/mch/order/delete-all']) ?>"
                ...
                <table class="table table-bordered bg-white">
                    <tr>
                        <td colspan="5" class="text-center">
                            <span class="mr-4"><span class="titleColor">商户店铺名称：</span><?= $order_item['name'] ?></span>
                            <span class="mr-4"><span class="titleColor">商户联系人：</span><?= $order_item['realname'] ?></span>
                    ...
                    <tr>
                        ...
                        <td class="order-tab-2">
                            ...
                            <?php if ($order_item['express_price_1']) : ?>
                                    <span class="titleColor">（含运费：<span style="color:green;"><?= $order_item['express_price_1'] ?></span>元）</span>
                            ...
                            <?php if ($order_item['user_coupon_id']) : ?>
                                    <span class="titleColor">优惠券：<span style="color:red;"><?= $order_item['coupon_sub_price'] ?></span>元</span>
                            <?php endif; ?>
                            <?php if ($order_item['before_update_price']) : ?>
                                <?php if ($order_item['pay_price'] > $order_item['before_update_price']) : ?>
                                        <div class="titleColor">后台加价：<span style="color:red;"><?= $order_item['pay_price'] - $order_item['before_update_price'] ?></span>元
                                    </div>
                                <?php else : ?>
                                        <div class="titleColor">后台优惠：<span style="color:red;"><?= $order_item['before_update_price'] - $order_item['pay_price'] ?></span>元
                                    </div>
                                <?php endif; ?>
                            <?php endif; ?>
                            <?php if ($order_item['integral'] && $order_item['integral']['forehead_integral']) : ?>
                                    <div class="titleColor">使用<?= $order_item['integral']['forehead_integral'] ?>积分抵扣：<span style="color:red;"><?= $order_item['integral']['forehead'] ?></span>元</div>
                            <?php endif; ?>
                        ...
                        <td colspan="5">
                            ...
                            <?php if ($order_item['is_send'] == 1) : ?>
                                ...
                                <?php if ($order_item['is_offline'] == 0 || $order_item['express']) : ?>
                                    <span><span class="titleColor">快递单号：</span><a href="https://www.baidu.com/s?wd=<?= $order_item['express_no'] ?>"
