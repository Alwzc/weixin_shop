            ...
            <div class="step-block" flex="dir:left box:first">
                ...
                <div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <div class="input-group short-row">
                                <?php if ($goods['full_cat']['pieces']) : ?>
                                    <label class=" col-form-label"><?= $goods['full_cat']['pieces'] ?>件</label>
                                <?php else : ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <div class="input-group short-row">
                                <?php if ($goods['forehead']) : ?>
                                    <label class=" col-form-label"><?= $goods['forehead'] ?>元</label>
                                <?php else : ?>
                                    <label class=" col-form-label">未设置</label>
                                <?php endif; ?>
                            </div>
