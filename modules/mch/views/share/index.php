            ...
            <?php foreach ($list as $index => $value) : ?>
                <tr>
                    ...
                    <td data-toggle="tooltip"
                        data-placement="top" title="<?= $value['user_id'] ?>"><span class="label-text"><?= $value['user_id'] ?></span></td>
                    <td data-toggle="tooltip" data-placement="top" class="text-center" title="<?= $value['nickname'] ?>">
                        <div>
                            <img src="<?= $value['avatar_url'] ?>" style="width: 30px;height: 30px;margin-right: 10px;margin-bottom: 10px;">
                        </div>
                    ...
                    <td>
                        <div class="btn btn-group" role="group">
                            ...
                            <div class="dropdown-menu dropdown-menu-left" aria-labelledby="dropdownMenuButton">
                                ...
                                <a href="javascript:" class="dropdown-item qrcode-btn" data-id="<?= $value['user_id'] ?>"
