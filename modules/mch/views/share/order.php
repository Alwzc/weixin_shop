                    ...
                    <table class="table table-bordered bg-white">
                        ...
                        <tr>
                            ...
                            <td class="order-tab-2">
                                <div class="titleColor">实际付款：<span style="color: red;"><?= $order_item['pay_price'] ?></span>元</div>
                            </td>
                                    ...
                                    <?php if ($order_item['is_send'] == 1) : ?>
                                        <?php if ($order_item['is_offline'] == 0) : ?>
                                            ...
                                            <div class="titleColor">快递公司：
                                                <span class=" badge badge-default"><?= $order_item['express'] ?></span></div>
                                ...
                                <div flex="dir:left">
                                    <?php if ($order_item['share']): ?>
                                        <div class="p-2 text-left">
                                            ...
                                            <span class="ml-3"><?= $order_item['share']['name'] ? "姓名：" . $order_item['share']['name'] : "" ?></span>
                                            <span class="ml-3"><?= $order_item['share']['mobile'] ? "电话：" . $order_item['share']['mobile'] : "" ?></span>
                                            <div class="titleColor">一级佣金：<span style="color:red;"><?= floatval($order_item['first_price']) ?></span>元</div>
                                        </div>
                                    <?php endif; ?>
                                    <?php if ($order_item['share_1']) : ?>
                                        <div class="p-2 text-left">
                                            <span>昵称：<?= $order_item['share_1']['nickname'] ?></span>
                                            <span class="ml-3"><?= $order_item['share_1']['name'] ? "姓名：" . $order_item['share_1']['name'] : "" ?></span>
                                            <span class="ml-3"><?= $order_item['share_1']['mobile'] ? "电话：" . $order_item['share_1']['mobile'] : "" ?></span>
                                            <div class="titleColor">二级佣金：<span style="color:red;"><?= floatval($order_item['second_price']) ?></span>元</div>
                                        </div>
                                    <?php endif; ?>
                                    <?php if ($order_item['share_2']) : ?>
                                        <div class="p-2 text-left">
                                            <span>昵称：<?= $order_item['share_2']['nickname'] ?></span>
                                            <span class="ml-3"class="ml-3"><?= $order_item['share_2']['name'] ? "姓名：" . $order_item['share_2']['name'] : "" ?></span>
                                            <span class="ml-3"><?= $order_item['share_2']['mobile'] ? "电话：" . $order_item['share_2']['mobile'] : "" ?></span>
                                            <div class="titleColor">三级佣金：<span style="color:red;"><?= floatval($order_item['third_price']) ?></span>元</div>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                <?php if ($order_item['rebate'] > 0) : ?>
                                    <div class="p-1 text-left">
                                        <div class="titleColor">自购返利：<span style="color:red;"><?= floatval($order_item['rebate']) ?></span>元</div>
                                    </div>
                                <?php endif; ?>
                            </td>
                        </tr>
