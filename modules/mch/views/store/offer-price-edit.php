...
<div class="panel mb-3" id="app">
    ...
    <div class="panel-body">
        <form class="auto-form-submit" method="post"
            ...
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
                    <label class="col-form-label">全地区起送金额</label>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="fs-sm">注：若某个地区单独设置，则该地区的起送金额以单独设置为准</div>
                </div>
            </div>

            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
                    <label class="col-form-label">起送规则</label>
                </div>
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            <div class="form-group-label col-sm-2">
                                <label class="col-form-label">起送金额</label>
                            </div>
                            <div class="col-sm-6">
                                <div class="input-group">
