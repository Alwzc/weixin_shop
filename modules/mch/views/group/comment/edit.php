...
<div class="panel mb-3">
    ...
    <div class="panel-body">
        <form class="form auto-form" method="post" return="<?= $urlManager->createUrl(['mch/group/comment/index']) ?>">
        ...
        <div id="app" class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= $urlManager->createUrl(['mch/group/comment/search-goods']) ?>"
