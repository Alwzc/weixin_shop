                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"
                        ...
                        <a class="dropdown-item"
                           href="<?= $urlManager->createUrl(array_merge(['mch/group/data/goods'], $_GET, ['status' => 1])) ?>">按销量</a>
                        <a class="dropdown-item"
                           href="<?= $urlManager->createUrl(array_merge(['mch/group/data/goods'], $_GET, ['status' => 2])) ?>">按销售额</a>
                    </div>
                </div>
            </div>
