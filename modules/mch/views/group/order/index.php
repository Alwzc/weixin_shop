                        ...
                        <div class="mr-4">
                            <div class="form-group">
                                ...
                                <a class="btn btn-secondary del"
                                   href="javascript:"
                                   data-url="<?= $urlManager->createUrl(['mch/group/order/delete-all']) ?>"
                ...
                <table class="table table-bordered bg-white">
                                ...
                                <?php if ($order_item['is_cancel'] == 0): ?>
                                    ...
                                    <span class="ml-1">
                                        <a class="btn btn-sm btn-info agree apply-status-btn"
                                           href="<?= $urlManager->createUrl(['mch/group/order/apply-delete-status', 'id' => $order_item['id'], 'status' => 1]) ?>">同意请求</a>
                                    </span>
                                    <span class="ml-1">
                                        <a class="btn btn-sm btn-danger refuse apply-status-btn"
                                           href="<?= $urlManager->createUrl(['mch/group/order/apply-delete-status', 'id' => $order_item['id'], 'status' => 0]) ?>">拒绝请求</a>
                                    </span>
                                <?php endif; ?>
                            <?php endif; ?>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="order-tab-2">
                            <div>
                                <span class="titleColor">总金额：<span style="color:blue;"><?= $order_item['total_price'] ?></span></span>
                                <span class="titleColor">（含运费：<span style="color:green;"><?= $order_item['express_price'] ?>元）</span></span>
                        ...
                        <td class="order-tab-5">
                            <?php if ($order_item['apply_delete'] == 0): ?>
                                ...
                                <?php endif; ?>
                            <?php endif; ?>
                            <?php if (($order_item['is_pay'] == 1 || $order_item['pay_type'] == 2) && $order_item['offline'] == 2 && $order_item['is_send'] != 1) : ?>
