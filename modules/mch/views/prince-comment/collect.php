...
<div class="panel mb-3">
    ...
    <div class="panel-body">
        ...
        <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="text-muted fs-sm">必须输入页码，请填需要采集的当前页码</div>
                </div>
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <div class="input-group">
               	<input class="form-control" name="need_key" value="">
                </div>
         ...
         <div class="form-group row">
            ...
            <div class="col-sm-6">
                <div class="input-group">
               	<input class="form-control" name="remove_key" value="">
                </div>
    ...
    <div class="form-group row">
        <div class="form-group-label col-sm-2 text-right">
            <label class="col-form-label required">是否过滤重复评论</label>
        </div>
        <div class="col-sm-6">
