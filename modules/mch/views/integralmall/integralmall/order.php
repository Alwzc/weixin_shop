                ...
                <table class="table table-bordered bg-white">
                    ...
                    <tr>
                        ...
                        <td class="order-tab-5">
                            <?php if ($order_item['apply_delete'] == 1) : ?>
                                    <div class="mb-2">
                                        <a class="btn btn-sm btn-info apply-status-btn"
                                           href="<?= $urlManager->createUrl(['mch/integralmall/integralmall/apply-delete-status', 'id' => $order_item['id'], 'status' => 1]) ?>">同意请求</a>
                                    </div>
                                    <div class="mb-2">
                                        <a class="btn btn-sm btn-danger refuse apply-status-btn"
                                           href="<?= $urlManager->createUrl(['mch/integralmall/integralmall/apply-delete-status', 'id' => $order_item['id'], 'status' => 0]) ?>">拒绝请求</a>
                                    </div>
                                <?php endif; ?>
                            <div>
                            <?php if ($order_item['is_pay'] == 1 && $order_item['is_confirm'] == 0) : ?>
                            ...
                            <?php endif; ?>
                                <?php if (($order_item['is_pay'] == 1 || $order_item['pay_type'] == 2) && $order_item['is_offline'] == 2 && $order_item['is_send'] != 1) : ?>
                                    <div>
