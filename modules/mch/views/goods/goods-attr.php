...
<div class="main-body p-3" id="page">
    <form class="form auto-submit-form" method="post" autocomplete="off" adata-return="<?= $returnUrl ?>">
        <div class="form-title">商品规格及库存设置</div>
        <div class="form-body">
                                ...
                                <td class="image-btn">
                                    <div class="image-picker" data-url="<?= $urlManager->createUrl(['upload/image']) ?>">
                                        ...
                                        <div class="image-picker-view-item">
                                            <input class="image-picker-input" type="hidden" v-bind:name="'attr['+index+'][pic]'" v-bind:value="item.pic">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table>
                        ...
                        <tr>
                            <td><label class="col-form-label">货号</label></td>
                            <td><input class="form-control update" type="text" data-index="no"></td>
                        </tr>
                    </table>
                </div>
    ...
    $(document).on('input', '.update', function () {
        ...
        $('.select:checked').each(function (i) {
            ...
            if (index == 'num') {
                ...
                page.checked_attr_list[j].no = val;
            }
        });
    });
